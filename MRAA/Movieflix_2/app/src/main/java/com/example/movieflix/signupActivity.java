...
public class signupActivity extends AppCompatActivity {
    ...
    private void setupUIViews(){
        userName = (EditText)findViewById(R.id.nameEditText2);
        userPassword = (EditText)findViewById(R.id.passwordEditText2);
        userEmail = (EditText)findViewById(R.id.usernameEditText2);
        regButton = (Button)findViewById(R.id.signupButton2);
        userLogin = (TextView)findViewById(R.id.loginbutton2);
